...
//    
//    @State private var editCar: CarModel?
//    
...
//            
//            ForEach(Array(carViewModel.cars), id: \.id) { car in
//                HStack {
...
//                            
//                            Button {
//                                if let vinNumberIndex = carViewModel.cars.firstIndex( where: { $0.vinNumber == car.vinNumber }) {
//                                    let currencyCar = carViewModel.cars[vinNumberIndex]
...
//                            
//                            Button {
//                                if let indexCar = carViewModel.cars.firstIndex(where: { $0.id == car.id }) {
